      ...
      {projectInfo[activeImageIndex].project ? (
        <>
          <Preview autoPlay muted>
            <source
              src={projectInfo[activeImageIndex].gifSrc}
              type="video/mp4"
            />
          </Preview>
          <Overlay>
            ...
            <div className="links">
              <motion.a
                ...
                whileTap={{ scale: 0.9 }}
                href={projectInfo[activeImageIndex].codeSrc}
                target="_blank"
              >
                Code
              </motion.a>
              ...
              <motion.a
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.9 }}
                href={projectInfo[activeImageIndex].liveSrc}
                target="_blank"
              >
                Preview
              </motion.a>
        ...
        <OpenSource>
          <div className="title">
            <img
              src={projectInfo[activeImageIndex].logoSrc}
          ...
          <div className="details">
            {projectInfo[activeImageIndex].contributions.map((info, index) => (
              <div key={index}>
                <a rel="noreferrer" href={info.repoSrc} target="_blank">
                  {info.repoName}
                </a>
                <span> | </span>
                <a rel="noreferrer" href={info.prSrc} target="_blank">
                  PR example
                </a>
              </div>
            ))}
